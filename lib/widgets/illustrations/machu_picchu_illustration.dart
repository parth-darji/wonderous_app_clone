...
class MachuPicchuIllustration extends StatelessWidget {
  ...
  List<Widget> _buildBg(BuildContext context, Animation<double> anim) {
    return [
      ...
      Align(
        alignment:
            config.shortMode ? Alignment.center : const Alignment(.75, -.6),
  ...
  List<Widget> _buildMg(BuildContext context, Animation<double> anim) => [
        Center(
          child: Transform.scale(
            ...
            alignment: Alignment(
                config.shortMode ? 0 : .15, config.shortMode ? -0.6 : .3),
            child: WonderHero(
              config,
              'machu-mg',
              child: Image.asset(
            ...
            child: Transform.scale(
              ...
              child: FractionallySizedBox(
                ...
                child: FractionalTranslation(
                  ...
                  child: Image.asset('$assetPath/foreground-back.png',
                      opacity: anim),
                ),
              ),
            ),
              ...
              child: Transform.scale(
                ...
                child: FractionallySizedBox(
                  ...
                  child: FractionalTranslation(
                    ...
                    child: Image.asset('$assetPath/foreground-front.png',
                        opacity: anim),
                  ),
                ),
              ),
