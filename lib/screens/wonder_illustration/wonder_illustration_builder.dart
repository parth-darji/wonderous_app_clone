...
class WonderIllustrationBuilder extends StatefulWidget {
  ...
  State<WonderIllustrationBuilder> createState() =>
      _WonderIllustrationBuilderState();
}

class _WonderIllustrationBuilderState extends State<WonderIllustrationBuilder>
  ...
  Widget build(BuildContext context) {
    ...
    if (_anim.value == 0 && widget.config.enableAnims) {
      return const SizedBox.expand();
    }
    Animation<double> anim =
        widget.config.enableAnims ? _anim : const AlwaysStoppedAnimation(1);
